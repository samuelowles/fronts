...
from fronts.game.action_space import ActionCodec, enumerate_publishes, restamp_unique
...
from fronts.game.payoff import Economics, reward
...
class ReferenceConfig:
    ...
    """The worked-example unit economics from ``fronts.game.payoff``'s tests,
...
class ReferenceWorldModel:
    ...
    def get_observations(self, state: State) -> dict[int, Observation]:
        ...
        measured constants in ``fronts.game.priors``; the platform and the
