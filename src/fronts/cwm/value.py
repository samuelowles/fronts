...
the tournament adds noise to the comparison.
"""
...
def tournament(
    ...
    host's quirks, which is what rotating hosts catches."""
...
def select_best(
    ...
    two of ten games, and a heuristic that does not clear the baseline makes
    the planner worse."""
    if not scored:
        return None
